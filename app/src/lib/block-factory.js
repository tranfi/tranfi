const defaults = {
  ...
  'onehot': { column: '', drop: false },
  'label-encode': { column: '', result: '' },
  'ewma': { column: '', alpha: 0.3, result: '' },
  'diff': { column: '', order: 1, result: '' },
  'anomaly': { column: '', threshold: 3, result: '' },
  'split-data': { ratio: 0.8, seed: 42 },
  'interpolate': { column: '', method: 'linear' },
